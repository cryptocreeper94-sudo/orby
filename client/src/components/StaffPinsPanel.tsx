  ...
  return (
    <>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${ROLE_COLORS[staff.role] || 'from-white/10 to-white/10'} flex items-center justify-center shadow-lg`}>
                    ...
                    <div className="flex items-center gap-3">
                      {staff.pinChanged ? (
                        ...
                        <Badge className="bg-white/10 text-white/40 border-white/10">
                          No PIN
                        </Badge>
                      )}
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 text-white/40 hover:text-cyan-400"
      ...
      <Dialog open={showAddModal} onOpenChange={setShowAddModal}>
        <DialogContent className="bg-[#0c1224] border-white/10">
          <DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label className="text-white/70">Department (optional)</Label>
              <Select
            ...
            <div>
              <Label className="text-white/70">Preset PIN</Label>
