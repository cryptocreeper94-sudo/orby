...
export function AppFooter({ companyLogo, companyName = 'Legends' }: AppFooterProps) {
  ...
  return (
    <>
      <footer className="fixed bottom-0 left-0 right-0 z-30 bg-gray-900/90 backdrop-blur-sm border-t border-gray-700/50">
        <div className="flex items-center justify-between px-4 py-2 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            {companyLogo ? (
              ...
              <span className="text-sm font-semibold text-white/80">{companyName}</span>
            )}
            <span className="text-xs text-gray-500">Beta Partner</span>
          </div>
