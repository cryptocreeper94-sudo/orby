  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-4 right-4 flex items-center gap-2 bg-gray-900/80 backdrop-blur-xl border border-cyan-500/30 rounded-full px-4 py-2 text-sm shadow-lg shadow-cyan-500/10 hover:border-cyan-500/50 transition-colors z-40"
        ...
        {isModalOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-20 right-4 w-96 max-h-[70vh] overflow-hidden bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/10 z-50"
