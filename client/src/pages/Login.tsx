...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-cyan-900 to-slate-800 p-4" data-testid="login-page">
      ...
      <div className="flex-1 flex items-center justify-center w-full">
        <LayoutShell className="w-full max-w-6xl items-center justify-center">
          ...
          >
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8" data-testid="form-login">
                <FormField
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10" data-testid="persistence-option">
                    <Checkbox
                      id="persistence"
                  ...
                  <AnimatePresence>
                    {showPersistenceWarning && (
                      ...
                      >
                        <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-start gap-2" data-testid="persistence-warning">
            ...
            <div className="mt-6" data-testid="pin-help-section">
              <button
                type="button"
      ...
      <footer className="w-full text-center py-4 space-y-1" data-testid="login-footer">
      ...
      <AnimatePresence>
        {showDevRolePicker && (
          <motion.div
            ...
            data-testid="dev-role-picker-overlay"
          >
            <motion.div
