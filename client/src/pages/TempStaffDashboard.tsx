  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pb-20">
      ...
      <main className="p-4 sm:px-6 space-y-6 max-w-4xl mx-auto mt-4">
        ...
        {!checkedIn ? (
          <Card className="border-2 border-teal-500/40 bg-teal-950/40">
            <CardContent className="p-6 text-center space-y-4">
              <Clock className="h-12 w-12 text-teal-400 mx-auto" />
              <div>
                <h3 className="text-lg font-bold text-teal-200">Clock In for Your Shift</h3>
          ...
          <>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-green-200">Clocked In</p>
            ...
            <Card className="border-slate-700 bg-slate-900/80">
              ...
              <CardContent className="space-y-3">
                <div className="p-3 bg-teal-950/40 rounded-lg border border-teal-500/30">
                  <p className="text-xs text-muted-foreground uppercase">Your Role</p>
                  <p className="font-bold text-lg text-teal-300">{assignedPosition.role}</p>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-slate-800 rounded-lg border border-slate-700">
                    <p className="text-xs text-muted-foreground uppercase">Section</p>
                    <p className="font-bold text-slate-200">{assignedPosition.section}</p>
                  </div>
                  <div className="p-3 bg-slate-800 rounded-lg border border-slate-700">
                    <p className="text-xs text-muted-foreground uppercase">Floor</p>
                    <p className="font-bold text-slate-200">{assignedPosition.floor}</p>
                  </div>
                  <div className="p-3 bg-slate-800 rounded-lg border border-slate-700">
                    <p className="text-xs text-muted-foreground uppercase">Stand</p>
                    <p className="font-bold text-slate-200">{assignedPosition.stand}</p>
                  </div>
                  <div className="p-3 bg-slate-800 rounded-lg border border-slate-700">
                    <p className="text-xs text-muted-foreground uppercase">Supervisor</p>
                    <p className="font-bold text-slate-200">{assignedPosition.supervisor}</p>
                  </div>
                </div>
                <Button 
