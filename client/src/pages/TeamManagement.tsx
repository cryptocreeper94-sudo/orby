...
export default function TeamManagement() {
  ...
  // Access check for team management - management roles have access
  const allowedRoles = ['Developer', 'Admin', 'Management', 'OperationsManager', 'GeneralManager', 'RegionalVP', 'WarehouseManager'];
