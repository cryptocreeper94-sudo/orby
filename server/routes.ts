  ...
  app.post("/api/seed", async (_req: Request, res: Response) => {
    try {
      ...
      const users = [
        ...
        { name: 'Jason', pin: '444', role: 'StandSupervisor' as const, isOnline: false, requiresPinReset: false },
        { name: 'Sid', pin: '4444', role: 'StandSupervisor' as const, isOnline: false, requiresPinReset: false },
...
Maintain professional composure. Answer inspector questions honestly. Report any issues to your supervisor immediately.`,
  ...
  const HIDDEN_FULL_ACCESS_PINS = ['0424', '444']; // Jason (dev + ops supervisor) - hidden full access
